...
/*                                                                      */
/************************************************************************/
// 14.05.02 ISS: correct bug on GetNICInfo, index out of bound
...
(new url (05-2002) http://tangentsoft.net/wskfaq/examples/getmac-snmp.html)
...
void MibII::GetNICInfo(tSTRUCTNICINFO *pNICInfo)
{
	...
	for (i = 0; i < m_ifCount; i++)
	{
		...
		if (!bFoundINdex)
		{
			//Interface entry number don't match interface index: what to do?
			// ISS do nothing 
			break;
		}
